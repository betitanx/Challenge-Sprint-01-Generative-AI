...
- `notebooks/sprint1_genai_fundamentos.ipynb`: notebook executável com comparativo, execução de prompts (API/mock), avaliação de input/output e validações.
...
## Evidências de avaliação de prompts

- `data/prompt_eval_results.csv`: resultados por caso/técnica (input, output, esperado).
- `data/prompt_eval_summary.csv`: resumo de acurácia factual por técnica.
